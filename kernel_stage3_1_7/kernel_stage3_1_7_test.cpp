...
// use count_depth to define size
    ...
    float norm1_mean[80*7]; 
    float norm1_var[80*7]; 
...
int main()
{
    ...
    for (int i = 0; i < 6000*7; i++)
        dw_conv_1_filter[i] = 0.5;

    for (int i = 0; i < 19200*7; i++)
        proj_1_weight[i] = 0.8;

    // execution
    kernel_stage3_1_7(buffer_DataIn_1,
                              afterNorm,
