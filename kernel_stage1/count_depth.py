...
parameters = {
    ...
    # depth 1
    'Y_norm_1': [1, 6, 28, 28],
    'Y_v_conv_1': [1, 24, 28, 28],
    'Y_dw_conv_1': [1, 24, 14, 14],
    'Y_dw_norm_1': [1, 24, 14, 14],
    'Y_dw_act_1': [1, 24, 14, 14],
    'Y_proj_1': [1, 8, 14, 14],
    # depth 2
    'Y_norm_2': [1, 8, 14, 14],
    'Y_v_conv_2': [1, 16, 14, 14],
    'Y_dw_conv_2': [1, 16, 14, 14],
    'Y_dw_norm_2': [1, 16, 14, 14],
    'Y_dw_act_2': [1, 16, 14, 14],
    'Y_proj_2': [1, 8, 14, 14],
    'Y_dw_skip_2': [1, 16, 14, 14],
    'Y_skip_2': [1, 8, 14, 14]
}
