...
static void load_input(int *buffer_DataIn_1,
                       int *buffer_DataIn_2,
                       int *buffer_result,
                       int in[BATCH_SIZE][CHANNEL_IN][HEIGHT_IN][WIDTH_IN],
                       int kernel[CHANNEL_OUT][KERNEL_SIZE][KERNEL_SIZE],
                       int out[BATCH_SIZE][CHANNEL_OUT][HEIGHT_OUT][WIDTH_OUT])
{
init_in:
...
static void compute_conv(int in[BATCH_SIZE][CHANNEL_IN][HEIGHT_IN][WIDTH_IN],
                         int kernel[CHANNEL_OUT][KERNEL_SIZE][KERNEL_SIZE],
                         int *buffer_result)
{
...
extern "C"
{
    void kernel_conv(int *buffer_DataIn_1,
                     int *buffer_DataIn_2,
                     int *buffer_result)
    {
