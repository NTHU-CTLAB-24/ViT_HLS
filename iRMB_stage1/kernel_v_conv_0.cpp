...
extern "C"
{
    ...
    */
    ...
    void kernel_v_conv_0(float *buffer_DataIn_1,
                     float *buffer_result)
    {
// TODO: modify depth
#pragma HLS INTERFACE m_axi port = buffer_DataIn_1 bundle = gmem0 depth = 1536
#pragma HLS INTERFACE m_axi port = buffer_result bundle = gmem0 depth = 6144
