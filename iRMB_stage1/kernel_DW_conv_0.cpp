...
const int CHANNEL_IN = 96;
const int CHANNEL_OUT = 96;
...
extern "C"
{
    ...
    */
    ...
    void kernel_DW_conv_0(float *buffer_DataIn_1,
                        float *buffer_result)
    {
// TODO: modify depth
#pragma HLS INTERFACE m_axi port = buffer_DataIn_1 bundle = gmem0 depth = 6144
#pragma HLS INTERFACE m_axi port = buffer_result bundle = gmem0 depth = 1536
