...
set name kernel_attention_fadd_32ns_32ns_32_1_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_fmul_32ns_32ns_32_1_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fmul} IMPL {maxdsp} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_mul_62s_7ns_62_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_srem_32ns_8ns_8_36_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln339 \
    op interface \
    ports { bitcast_ln339 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln317 \
    op interface \
    ports { select_ln317 { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_mid2156 \
    op interface \
    ports { p_mid2156 { I 14 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln317_7 \
    op interface \
    ports { select_ln317_7 { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln317_8 \
    op interface \
    ports { select_ln317_8 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln339_2 \
    op interface \
    ports { zext_ln339_2 { I 15 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { add8122_out { O 32 vector } add8122_out_ap_vld { O 1 bit } } \
} "
}
