...
set name kernel_attention_fcmp_32ns_32ns_1_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fcmp} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_mul_3ns_15ns_16_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 178
set name kernel_attention_mac_muladd_8ns_6ns_16ns_16_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_afterAct2 \
    op interface \
    ports { afterAct2 { I 64 vector } } \
} "
}
