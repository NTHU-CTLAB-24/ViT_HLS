set moduleName compute_skip_Pipeline_VITIS_LOOP_584_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute_skip_Pipeline_VITIS_LOOP_584_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln580 int 8 regular  }
	{ bound66 int 16 regular  }
	{ gmem int 32 regular {axi_master 2}  }
	{ bound21 int 14 regular  }
	{ afterAct int 64 regular  }
	{ buffer_result int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln580", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "bound66", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bound21", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "afterAct", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "buffer_result", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln580 sc_in sc_lv 8 signal 0 } 
	{ bound66 sc_in sc_lv 16 signal 1 } 
	{ bound21 sc_in sc_lv 14 signal 3 } 
	{ afterAct sc_in sc_lv 64 signal 4 } 
	{ buffer_result sc_in sc_lv 64 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln580", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln580", "role": "default" }} , 
 	{ "name": "bound66", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bound66", "role": "default" }} , 
 	{ "name": "bound21", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "bound21", "role": "default" }} , 
 	{ "name": "afterAct", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "afterAct", "role": "default" }} , 
 	{ "name": "buffer_result", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "buffer_result", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_8ns_10_1_1_U65", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_8ns_10_1_1_U66", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "439043", "Max" : "658563"}
	, {"Name" : "Interval", "Min" : "439043", "Max" : "658563"}
]}
...
set Spec2ImplPortList { 
	zext_ln580 { ap_none {  { zext_ln580 in_data 0 8 } } }
	bound66 { ap_none {  { bound66 in_data 0 16 } } }
	...
	bound21 { ap_none {  { bound21 in_data 0 14 } } }
	afterAct { ap_none {  { afterAct in_data 0 64 } } }
	buffer_result { ap_none {  { buffer_result in_data 0 64 } } }
}
