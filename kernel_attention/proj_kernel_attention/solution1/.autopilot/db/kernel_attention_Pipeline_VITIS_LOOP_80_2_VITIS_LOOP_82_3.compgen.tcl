...
set id 25
set name kernel_attention_mac_muladd_7ns_8ns_9s_15_4_1
...
set ce_signed 0
set out_width 15
set arg_lists {i0 {7 0 +} i1 {8 0 +} m {15 1 +} i2 {9 1 +} p {15 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set id 26
set name kernel_attention_mac_muladd_7ns_6ns_7s_13_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 13
set arg_lists {i0 {7 0 +} i1 {6 0 +} m {13 1 +} i2 {7 1 +} p {13 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_afterPad \
    op interface \
    ports { afterPad { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_afterRearrangeX \
    op interface \
    ports { afterRearrangeX { I 64 vector } } \
} "
}
