...
set id 170
set name kernel_attention_ama_addmuladd_5ns_6ns_6ns_3ns_12_4_1
...
set ce_signed 0
set out_width 12
set arg_lists {i0 {5 0 +} i1 {6 0 +} s {7 0 +} i2 {6 0 +} m {12 1 +} i3 {3 0 +} p {12 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_afterRearrangeQKX \
    op interface \
    ports { afterRearrangeQKX { I 64 vector } } \
} "
}
