...
set id 100
set name kernel_attention_ama_addmuladd_6ns_10ns_6ns_6ns_16_4_1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {6 0 +} i1 {10 0 +} s {10 0 +} i2 {6 0 +} m {16 1 +} i3 {6 0 +} p {16 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln206_1 \
    op interface \
    ports { sext_ln206_1 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln204 \
    op interface \
    ports { mul_ln204 { I 10 vector } } \
} "
}
