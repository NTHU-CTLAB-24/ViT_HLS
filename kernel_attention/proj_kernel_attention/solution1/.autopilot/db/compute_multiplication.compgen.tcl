...
set name kernel_attention_mul_4ns_6ns_10_1_1
...
set id 112
set name kernel_attention_mac_muladd_4ns_6ns_6ns_10_4_1
...
set ce_signed 0
set out_width 10
set arg_lists {i0 {4 0 +} i1 {6 0 +} m {10 1 +} i2 {6 0 +} p {10 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 113
set name kernel_attention_mul_mul_10ns_6ns_16_4_1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {10 0 +} i1 {6 0 +} p {16 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
