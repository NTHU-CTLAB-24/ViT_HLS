...
set name kernel_attention_fdiv_32ns_32ns_32_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fdiv} IMPL {fabric} LATENCY 1 ALLOW_PRAGMA 1
}


set name kernel_attention_mul_3ns_15ns_15_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_mul_3ns_13ns_15_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
set id 151
set name kernel_attention_mac_muladd_6ns_6ns_15ns_15_4_1
...
set ce_signed 0
set out_width 15
set arg_lists {i0 {6 0 +} i1 {6 0 +} m {12 0 +} i2 {15 0 +} p {15 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln230_1 \
    op interface \
    ports { sext_ln230_1 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_afterQKMultiplication \
    op interface \
    ports { afterQKMultiplication { I 64 vector } } \
} "
}
