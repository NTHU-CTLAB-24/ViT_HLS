set moduleName kernel_attention_Pipeline_VITIS_LOOP_373_3_VITIS_LOOP_375_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {kernel_attention_Pipeline_VITIS_LOOP_373_3_VITIS_LOOP_375_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 1}  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ sext_ln371_1 int 62 regular  }
	{ sext_ln371 int 62 regular  }
	{ empty float 32 regular  }
	{ tmp double 64 regular  }
	{ conv32_i double 64 regular  }
	{ conv36_i double 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "afterNorm","offset": { "type": "dynamic","port_name": "afterNorm","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "buffer_DataIn_1","offset": { "type": "dynamic","port_name": "buffer_DataIn_1","bundle": "control"},"direction": "READONLY"},{"cName": "buffer_result","offset": { "type": "dynamic","port_name": "buffer_result","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln371_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conv32_i", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "conv36_i", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln371_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln371 sc_in sc_lv 62 signal 3 } 
	{ empty sc_in sc_lv 32 signal 4 } 
	{ tmp sc_in sc_lv 64 signal 5 } 
	{ conv32_i sc_in sc_lv 64 signal 6 } 
	{ conv36_i sc_in sc_lv 64 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln371_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln371_1", "role": "default" }} , 
 	...
 	{ "name": "conv32_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "conv32_i", "role": "default" }} , 
 	{ "name": "conv36_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "conv36_i", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fsub_32ns_32ns_32_1_full_dsp_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fptrunc_64ns_32_1_no_dsp_1_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpext_32ns_64_1_no_dsp_1_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadd_64ns_64ns_64_1_full_dsp_1_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_2_max_dsp_1_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_5_no_dsp_1_U6", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln371_1 { ap_none {  { sext_ln371_1 in_data 0 62 } } }
	sext_ln371 { ap_none {  { sext_ln371 in_data 0 62 } } }
	empty { ap_none {  { empty in_data 0 32 } } }
	tmp { ap_none {  { tmp in_data 0 64 } } }
	conv32_i { ap_none {  { conv32_i in_data 0 64 } } }
	conv36_i { ap_none {  { conv36_i in_data 0 64 } } }
}
