set moduleName compute_multiplication_Pipeline_VITIS_LOOP_207_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute_multiplication_Pipeline_VITIS_LOOP_207_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_read3 int 6 regular  }
	{ sext_ln206_1 int 62 regular  }
	{ gmem int 32 regular {axi_master 0}  }
	{ mul_ln204 int 10 regular  }
	{ zext_ln203 int 6 regular  }
	{ zext_ln206 int 6 regular  }
	{ in_k int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read3", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln206_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mul_ln204", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln203", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln206", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_read3 sc_in sc_lv 6 signal 0 } 
	{ sext_ln206_1 sc_in sc_lv 62 signal 1 } 
	{ mul_ln204 sc_in sc_lv 10 signal 3 } 
	{ zext_ln203 sc_in sc_lv 6 signal 4 } 
	{ zext_ln206 sc_in sc_lv 6 signal 5 } 
	{ in_k sc_in sc_lv 64 signal 6 } 
	{ scale sc_in sc_lv 32 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln206_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln206_1", "role": "default" }} , 
 	{ "name": "mul_ln204", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mul_ln204", "role": "default" }} , 
 	{ "name": "zext_ln203", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln203", "role": "default" }} , 
 	{ "name": "zext_ln206", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln206", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_1_full_dsp_1_U98", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_1_max_dsp_1_U99", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ama_addmuladd_6ns_10ns_6ns_6ns_16_4_1_U100", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "54", "Max" : "112"}
	, {"Name" : "Interval", "Min" : "54", "Max" : "112"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln206_1 { ap_none {  { sext_ln206_1 in_data 0 62 } } }
	...
	mul_ln204 { ap_none {  { mul_ln204 in_data 0 10 } } }
	zext_ln203 { ap_none {  { zext_ln203 in_data 0 6 } } }
	zext_ln206 { ap_none {  { zext_ln206 in_data 0 6 } } }
