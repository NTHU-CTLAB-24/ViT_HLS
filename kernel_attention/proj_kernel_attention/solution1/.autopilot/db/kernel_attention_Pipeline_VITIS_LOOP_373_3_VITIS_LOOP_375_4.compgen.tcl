...
set name kernel_attention_fsub_32ns_32ns_32_1_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fsub} IMPL {fulldsp} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_fptrunc_64ns_32_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fptrunc} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_fpext_32ns_64_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fpext} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_dadd_64ns_64ns_64_1_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {dadd} IMPL {fulldsp} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_attention_dmul_64ns_64ns_64_2_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {dmul} IMPL {maxdsp} LATENCY 1 ALLOW_PRAGMA 1
}


set name kernel_attention_ddiv_64ns_64ns_64_5_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln371_1 \
    op interface \
    ports { sext_ln371_1 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv32_i \
    op interface \
    ports { conv32_i { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv36_i \
    op interface \
    ports { conv36_i { I 64 vector } } \
} "
}
...
set InstName kernel_attention_flow_control_loop_pipe_sequential_init_U
set CompName kernel_attention_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix kernel_attention_ \
}"
} else {
