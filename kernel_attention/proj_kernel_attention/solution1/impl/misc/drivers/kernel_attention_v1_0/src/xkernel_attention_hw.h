...
#define XKERNEL_ATTENTION_CONTROL_ADDR_BUFFER_DATAIN_1_DATA        0x010
#define XKERNEL_ATTENTION_CONTROL_BITS_BUFFER_DATAIN_1_DATA        64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERNORM_DATA              0x01c
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERNORM_DATA              64
#define XKERNEL_ATTENTION_CONTROL_ADDR_NORM1_MEAN_DATA             0x028
#define XKERNEL_ATTENTION_CONTROL_BITS_NORM1_MEAN_DATA             64
#define XKERNEL_ATTENTION_CONTROL_ADDR_NORM1_VAR_DATA              0x034
#define XKERNEL_ATTENTION_CONTROL_BITS_NORM1_VAR_DATA              64
#define XKERNEL_ATTENTION_CONTROL_ADDR_NORM1_WEIGHT_DATA           0x040
#define XKERNEL_ATTENTION_CONTROL_BITS_NORM1_WEIGHT_DATA           64
#define XKERNEL_ATTENTION_CONTROL_ADDR_NORM1_BIAS_DATA             0x04c
#define XKERNEL_ATTENTION_CONTROL_BITS_NORM1_BIAS_DATA             64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERPAD_DATA               0x058
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERPAD_DATA               64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERREARRANGEX_DATA        0x064
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERREARRANGEX_DATA        64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERPAD1_DATA              0x070
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERPAD1_DATA              64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERCONV1_DATA             0x07c
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERCONV1_DATA             64
#define XKERNEL_ATTENTION_CONTROL_ADDR_KERNEL1_DATA                0x088
#define XKERNEL_ATTENTION_CONTROL_BITS_KERNEL1_DATA                64
#define XKERNEL_ATTENTION_CONTROL_ADDR_BIAS1_DATA                  0x094
#define XKERNEL_ATTENTION_CONTROL_BITS_BIAS1_DATA                  64
#define XKERNEL_ATTENTION_CONTROL_ADDR_IN_QK_DATA                  0x0a0
#define XKERNEL_ATTENTION_CONTROL_BITS_IN_QK_DATA                  64
#define XKERNEL_ATTENTION_CONTROL_ADDR_IN_Q_DATA                   0x0ac
#define XKERNEL_ATTENTION_CONTROL_BITS_IN_Q_DATA                   64
#define XKERNEL_ATTENTION_CONTROL_ADDR_IN_K_DATA                   0x0b8
#define XKERNEL_ATTENTION_CONTROL_BITS_IN_K_DATA                   64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERQKMULTIPLICATION_DATA  0x0c4
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERQKMULTIPLICATION_DATA  64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERSOFTMAX_DATA           0x0d0
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERSOFTMAX_DATA           64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERREARRANGEX2_DATA       0x0dc
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERREARRANGEX2_DATA       64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERQKXMULTIPLICATION_DATA 0x0e8
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERQKXMULTIPLICATION_DATA 64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERREARRANGEQKX_DATA      0x0f4
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERREARRANGEQKX_DATA      64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERPAD2_DATA              0x100
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERPAD2_DATA              64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERCONV2_DATA             0x10c
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERCONV2_DATA             64
#define XKERNEL_ATTENTION_CONTROL_ADDR_KERNEL2_DATA                0x118
#define XKERNEL_ATTENTION_CONTROL_BITS_KERNEL2_DATA                64
#define XKERNEL_ATTENTION_CONTROL_ADDR_BIAS2_DATA                  0x124
#define XKERNEL_ATTENTION_CONTROL_BITS_BIAS2_DATA                  64
#define XKERNEL_ATTENTION_CONTROL_ADDR_AFTERACT2_DATA              0x130
#define XKERNEL_ATTENTION_CONTROL_BITS_AFTERACT2_DATA              64
#define XKERNEL_ATTENTION_CONTROL_ADDR_QKV_DATA                    0x13c
#define XKERNEL_ATTENTION_CONTROL_BITS_QKV_DATA                    64
#define XKERNEL_ATTENTION_CONTROL_ADDR_BUFFER_OUT_DATA             0x148
#define XKERNEL_ATTENTION_CONTROL_BITS_BUFFER_OUT_DATA             64
#define XKERNEL_ATTENTION_CONTROL_ADDR_BUFFER_RESULT_DATA          0x154
#define XKERNEL_ATTENTION_CONTROL_BITS_BUFFER_RESULT_DATA          64
