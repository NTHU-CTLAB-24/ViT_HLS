...
entity kernel_stage0_flow_control_loop_pipe_sequential_init is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity kernel_stage0_flow_control_loop_pipe_sequential_init;

architecture behav of kernel_stage0_flow_control_loop_pipe_sequential_init is
