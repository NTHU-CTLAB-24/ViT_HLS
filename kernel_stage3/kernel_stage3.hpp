#ifndef _KRNL_STAGE3_H_
#define _KRNL_STAGE3_H_
...
extern "C"
{
    void kernel_stage3(float* X_data, 
                        float* norm_1_weight, float* norm_1_bias,
                        ...
                        float* proj_1_weight, float* Y_norm_1, float* Y_v_conv_1, float* Y_v_act_1, float* Y_dw_conv_1, float* Y_dw_norm_1, float* Y_dw_act_1,
                        float *buffer_DataIn_1,
                        float *afterNorm,
                        ...
                        float *buffer_out,
                        float *buffer_result,
                        float* dw_conv_2_filter, float* dw_norm_2_weight, float* dw_norm_2_bias, float* dw_norm_2_mean, float* dw_norm_2_var,
                        float* proj_2_weight,
