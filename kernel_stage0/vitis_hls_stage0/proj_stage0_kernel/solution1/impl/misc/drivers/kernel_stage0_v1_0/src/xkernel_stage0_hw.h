...
#define XKERNEL_STAGE0_CONTROL_ADDR_X_DATA_DATA                0x010
#define XKERNEL_STAGE0_CONTROL_BITS_X_DATA_DATA                64
#define XKERNEL_STAGE0_CONTROL_ADDR_MSP_CONV_WEIGHT_DATA       0x01c
#define XKERNEL_STAGE0_CONTROL_BITS_MSP_CONV_WEIGHT_DATA       64
#define XKERNEL_STAGE0_CONTROL_ADDR_MSP_CONV_BIAS_DATA         0x028
#define XKERNEL_STAGE0_CONTROL_BITS_MSP_CONV_BIAS_DATA         64
#define XKERNEL_STAGE0_CONTROL_ADDR_MSP_NORM_WEIGHT_DATA       0x034
#define XKERNEL_STAGE0_CONTROL_BITS_MSP_NORM_WEIGHT_DATA       64
#define XKERNEL_STAGE0_CONTROL_ADDR_MSP_NORM_BIAS_DATA         0x040
#define XKERNEL_STAGE0_CONTROL_BITS_MSP_NORM_BIAS_DATA         64
#define XKERNEL_STAGE0_CONTROL_ADDR_MSP_NORM_RUNNING_MEAN_DATA 0x04c
#define XKERNEL_STAGE0_CONTROL_BITS_MSP_NORM_RUNNING_MEAN_DATA 64
#define XKERNEL_STAGE0_CONTROL_ADDR_MSP_NORM_RUNNING_VAR_DATA  0x058
#define XKERNEL_STAGE0_CONTROL_BITS_MSP_NORM_RUNNING_VAR_DATA  64
#define XKERNEL_STAGE0_CONTROL_ADDR_DW_CONV_WEIGHT_DATA        0x064
#define XKERNEL_STAGE0_CONTROL_BITS_DW_CONV_WEIGHT_DATA        64
#define XKERNEL_STAGE0_CONTROL_ADDR_NORM_1_WEIGHT_DATA         0x070
#define XKERNEL_STAGE0_CONTROL_BITS_NORM_1_WEIGHT_DATA         64
#define XKERNEL_STAGE0_CONTROL_ADDR_NORM_1_BIAS_DATA           0x07c
#define XKERNEL_STAGE0_CONTROL_BITS_NORM_1_BIAS_DATA           64
#define XKERNEL_STAGE0_CONTROL_ADDR_NORM_1_RUNNING_MEAN_DATA   0x088
#define XKERNEL_STAGE0_CONTROL_BITS_NORM_1_RUNNING_MEAN_DATA   64
#define XKERNEL_STAGE0_CONTROL_ADDR_NORM_1_RUNNING_VAR_DATA    0x094
#define XKERNEL_STAGE0_CONTROL_BITS_NORM_1_RUNNING_VAR_DATA    64
#define XKERNEL_STAGE0_CONTROL_ADDR_SE_CONV_REDUCE_WEIGHT_DATA 0x0a0
#define XKERNEL_STAGE0_CONTROL_BITS_SE_CONV_REDUCE_WEIGHT_DATA 64
#define XKERNEL_STAGE0_CONTROL_ADDR_SE_CONV_REDUCE_BIAS_DATA   0x0ac
#define XKERNEL_STAGE0_CONTROL_BITS_SE_CONV_REDUCE_BIAS_DATA   64
#define XKERNEL_STAGE0_CONTROL_ADDR_SE_CONV_EXPAND_WEIGHT_DATA 0x0b8
#define XKERNEL_STAGE0_CONTROL_BITS_SE_CONV_EXPAND_WEIGHT_DATA 64
#define XKERNEL_STAGE0_CONTROL_ADDR_SE_CONV_EXPAND_BIAS_DATA   0x0c4
#define XKERNEL_STAGE0_CONTROL_BITS_SE_CONV_EXPAND_BIAS_DATA   64
#define XKERNEL_STAGE0_CONTROL_ADDR_PROJ_CONV_WEIGHT_DATA      0x0d0
#define XKERNEL_STAGE0_CONTROL_BITS_PROJ_CONV_WEIGHT_DATA      64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_MSP_CONV_DATA            0x0dc
#define XKERNEL_STAGE0_CONTROL_BITS_Y_MSP_CONV_DATA            64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_MSP_NORM_DATA            0x0e8
#define XKERNEL_STAGE0_CONTROL_BITS_Y_MSP_NORM_DATA            64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_DW_CONV_DATA             0x0f4
#define XKERNEL_STAGE0_CONTROL_BITS_Y_DW_CONV_DATA             64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_DW_NORM_DATA             0x100
#define XKERNEL_STAGE0_CONTROL_BITS_Y_DW_NORM_DATA             64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_DW_ACT_DATA              0x10c
#define XKERNEL_STAGE0_CONTROL_BITS_Y_DW_ACT_DATA              64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_MEAN_DATA                0x118
#define XKERNEL_STAGE0_CONTROL_BITS_Y_MEAN_DATA                64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_REDUCE_DATA              0x124
#define XKERNEL_STAGE0_CONTROL_BITS_Y_REDUCE_DATA              64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_RELU_DATA                0x130
#define XKERNEL_STAGE0_CONTROL_BITS_Y_RELU_DATA                64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_EXPAND_DATA              0x13c
#define XKERNEL_STAGE0_CONTROL_BITS_Y_EXPAND_DATA              64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_SIGMOID_DATA             0x148
#define XKERNEL_STAGE0_CONTROL_BITS_Y_SIGMOID_DATA             64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_SE_DATA                  0x154
#define XKERNEL_STAGE0_CONTROL_BITS_Y_SE_DATA                  64
#define XKERNEL_STAGE0_CONTROL_ADDR_Y_PROJ_DATA                0x160
#define XKERNEL_STAGE0_CONTROL_BITS_Y_PROJ_DATA                64
