...
set name kernel_stage0_mul_62s_17ns_62_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name kernel_stage0_srem_32ns_3ns_3_36_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln64 \
    op interface \
    ports { bitcast_ln64 { I 32 vector } } \
} "
}
