set moduleName kernel_stage0_Pipeline_VITIS_LOOP_34_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {kernel_stage0_Pipeline_VITIS_LOOP_34_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 1}  }
	{ gmem1 int 32 regular {axi_master 0}  }
	{ sext_ln34_1 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "Y_msp_norm","offset": { "type": "dynamic","port_name": "Y_msp_norm","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_mean","offset": { "type": "dynamic","port_name": "Y_mean","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_sigmoid","offset": { "type": "dynamic","port_name": "Y_sigmoid","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln34_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln34_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln34 sc_in sc_lv 62 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln34_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln34_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fptrunc_64ns_32_1_no_dsp_1_U87", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpext_32ns_64_1_no_dsp_1_U88", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadd_64ns_64ns_64_2_full_dsp_1_U89", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_9_no_dsp_1_U90", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dexp_64ns_64ns_64_6_full_dsp_1_U91", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln34_1 { ap_none {  { sext_ln34_1 in_data 0 62 } } }
