set moduleName kernel_stage0_Pipeline_VITIS_LOOP_7_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {kernel_stage0_Pipeline_VITIS_LOOP_7_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem3 int 32 regular {axi_master 0}  }
	{ gmem0 int 32 regular {axi_master 1}  }
	{ Y_reduce int 64 regular  }
	{ Y_relu int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "Y_dw_conv","offset": { "type": "dynamic","port_name": "Y_dw_conv","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_reduce","offset": { "type": "dynamic","port_name": "Y_reduce","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_se","offset": { "type": "dynamic","port_name": "Y_se","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "X_data","offset": { "type": "dynamic","port_name": "X_data","bundle": "control"},"direction": "READONLY"},{"cName": "Y_dw_norm","offset": { "type": "dynamic","port_name": "Y_dw_norm","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_relu","offset": { "type": "dynamic","port_name": "Y_relu","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_proj","offset": { "type": "dynamic","port_name": "Y_proj","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "Y_reduce", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "Y_relu", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ Y_reduce sc_in sc_lv 64 signal 2 } 
	{ Y_relu sc_in sc_lv 64 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Y_reduce", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Y_reduce", "role": "default" }} , 
 	{ "name": "Y_relu", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Y_relu", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_1_no_dsp_1_U81", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	Y_reduce { ap_none {  { Y_reduce in_data 0 64 } } }
	Y_relu { ap_none {  { Y_relu in_data 0 64 } } }
}
