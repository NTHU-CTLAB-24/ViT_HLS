set moduleName kernel_stage0_Pipeline_Output_Channel
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {kernel_stage0_Pipeline_Output_Channel}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "Y_dw_conv","offset": { "type": "dynamic","port_name": "Y_dw_conv","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_reduce","offset": { "type": "dynamic","port_name": "Y_reduce","bundle": "control"},"direction": "READWRITE"},{"cName": "Y_se","offset": { "type": "dynamic","port_name": "Y_se","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "Y_proj", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "Y_se", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln25 sc_in sc_lv 62 signal 3 } 
	{ Y_proj sc_in sc_lv 64 signal 4 } 
	{ Y_se sc_in sc_lv 64 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Y_proj", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Y_proj", "role": "default" }} , 
 	{ "name": "Y_se", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Y_se", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5ns_14ns_15s_20_4_1_U105", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7225388", "Max" : "7225388"}
	, {"Name" : "Interval", "Min" : "7225388", "Max" : "7225388"}
]}
...
set Spec2ImplPortList { 
	...
	Y_proj { ap_none {  { Y_proj in_data 0 64 } } }
	Y_se { ap_none {  { Y_se in_data 0 64 } } }
}
