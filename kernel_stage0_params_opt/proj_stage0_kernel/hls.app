<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" top="kernel_stage0" name="proj_stage0_kernel">
    <includePaths/>
    <libraryFlag/>
    <files>
        ...
        <file name="stage0_resources.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="SiLU.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
